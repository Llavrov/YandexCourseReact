    ...
    return (
        <ModalOverlay onClose={setClose}>
            <Modal onClose={setClose} header={''}>
                ...
                <p className="pb-30 text text_type_main-small" style={{color: 'rgba(133, 133, 173, 1)'}}>дождитесь готовности заказа на орбитальной станции</p>
            </Modal>
        </ModalOverlay>
    )
}
